export default [
	...
	},
	{
		...
		Type        : 'Saturation',
		Use         : 'Mixing',
		Description : 'Apicolypse is a re-release of my old API-style color adder, exactly as it was.',
		Comments    : ''
	},
	{
		...
		Type        : 'Utility',
		Use         : 'Post',
		Description : 'Soften headset mic recordings that have been super hard clipped on capture',
		Comments    :
	...
	},
	{
		...
		Type        : 'EQ',
		Use         : 'Mixing',
		Description : 'A lowpass filter you probably don’t have in your DAW, with a distinctive tone',
		Comments    :
	...
	},
	{
		...
		Type        : 'EQ',
		Use         : 'Mixing',
		Description : 'Biquad2 is the Airwindows biquad filter that’s more sweepable and synthy.',
		Comments    : ''
	},
	{
		Name        : 'Bite',
	...
	},
	{
		...
		Type        : 'Bitcrusher',
		Use         : 'Mixing',
		Description : 'Hardware-style bit and resolution crusher, like really old sampler',
		Comments    : ''
	},
	{
		Name        : 'BitShiftGain',
	...
	},
	{
		...
		Type        : 'Mix Buss Replacement',
		Use         : 'Mixing',
		Description : 'The original Console5 with DC offset (and a very minimal, defeatable DC remover)',
		Comments    : ''
	},
	{
		Name        : 'Calibre',
	...
	},
	{
		...
		Type        : 'Saturation',
		Use         : 'Mixing',
		Description : 'Channel7 improves slew clipping and lets you blend Channel 6 and 5.',
		Comments    : ''
	},
	{
		Name        : 'Chorus',
	...
	},
	{
		...
		Type        : 'Clipper',
		Use         : 'Mastering',
		Description : '2-buss safety clipper at -0.2dB with powerful anti-glare processing',
		Comments    : ''
	},
	{
		Name        : 'Coils',
		Type        : 'Distortion',
		Use         : 'Mixing',
		Description : 'Coils models the types of distortion you’ll find in transformers.',
		Comments    :
	...
	},
	{
		...
		Comments    : 'The signal flow goes like this:\nGate—Highpass—Compressor—EQ(High/Mid/Low)—Timing—Lowpass'
	},
	{
		Name        : 'Curve',
		Type        : 'Compressor',
		Use         : 'Mixing',
		Description : 'curve is the simplest, purest form of airwindows recurve with no extra boosts.',
		Comments    : ''
	},
	{
		Name        : 'DCVoltage',
	...
	},
	{
		...
		Type        : 'De-esser',
		Use         : 'Mixing',
		Description : 'DeEss is the best de-essing solution there is. A go-to utility plugin.',
		Comments    : ''
	},
	{
		Name        : 'DeHiss',
	...
	},
	{
		...
		Type        : 'Dither',
		Use         : 'Mastering',
		Description : "It's (nearly) every Airwindows dither plugin in one box, with a control to select between them.",
		Comments    : ''
	},
	{
		Name        : 'DitherFloat',
		Type        : 'Dither',
		Use         : 'Mixing',
		Description : 'Look down. Look up. Your plugins are now dithered to 32 bit floating point :D',
		Comments    : ''
	},
	{
		Name        : 'DoublePaul',
	...
	},
	{
		...
		Type        : 'Utility',
		Use         : 'Mixing',
		Description : 'DubCenter is a version of DubSub where the bass reinforcement is purely mono.',
		Comments    : ''
	},
	{
		Name        : 'DubSub',
	...
	},
	{
		...
		Type        : 'Saturation',
		Use         : 'Mixing',
		Description : 'Dyno is a lot like Mojo, but for intensity instead of loudness.',
		Comments    : ''
	},
	{
		Name        : 'Ed Is Dim',
	...
	},
	{
		...
		Use         : 'Mixing',
		Description : 'Hihat tone generator (uses original sound as control voltage)',
		Comments    : ''
	},
	{
		Name        : 'Energy',
	...
	},
	{
		...
		Type        : 'Limiter',
		Use         : 'Mixing',
		Description : 'Facet is a new kind of hard clip that adds two sharp corners into the wave.',
		Comments    : ''
	},
	{
		Name        : 'FathomFive',
	...
	},
	{
		...
		Comments    : 'For the 2buss. Can cut mostly treble for toms, or tighten bass on kicks and snares.'
	},
	{
		Name        : 'Golem',
		Type        : 'Utility',
	...
	},
	{
		...
		Type        : 'EQ',
		Use         : 'Mixing',
		Description : 'Highpass2 is an unusual-sounding variable-slope highpass filter.',
		Comments    : ''
	},
	{
		Name        : 'Holt',
	...
	},
	{
		...
		Comments    : 'This is the old school, rowdy, obvious tape emulation, full of grunge and bark :)'
	},
	{
	...
	},
	{
		...
		Type        : 'EQ',
		Use         : 'Mixing',
		Description : 'Lowpass2 is an unusual-sounding variable-slope lowpass filter.',
		Comments    : ''
	},
	{
		Name        : 'Luxor',
		Type        : 'Saturation',
		Use         : 'Mixing',
		Description : 'Luxor is the Character plugin that’s based off Manley impulses.',
		Comments    :
	...
	},
	{
		...
		Type        : 'Utility',
		Use         : 'Mixing',
		Description : 'MoNoam gives you variations on mono, mid, and side in different channels.',
		Comments    : ''
	},
	{
		Name        : 'MV',
		Type        : 'Reverb',
		Use         : 'Mixing',
		Description : 'MV is a dual-mono reverb based on BitShiftGain and the old Midiverbs',
		Comments    : ''
	},
	{
	...
	},
	{
		...
		Comments    : 'Can be used in sound design for video, or as a texture for music.'
	},
	{
		Name        : 'NonLinearSpace',
		Type        : 'Reverb',
	...
	},
	{
		...
		Type        : 'Dither',
		Use         : 'Mastering',
		Description : 'NotJustAnotherDither is 24 bit and NotJustAnotherCD is 16 bit',
		Comments    :
	...
	},
	{
		...
		Type        : 'Utility',
		Use         : 'Mixing',
		Description : 'Podcast is a simpler pile of curve-style compressors with hard clipping.',
		Comments    :
	...
	},
	{
		...
		Type        : 'Compressor',
		Use         : 'Mixing',
		Description : 'PodcastDeluxe is a pile of compressors (curve style) and phase rotators.',
		Comments    : ''
	},
	{
		Name        : 'Point',
	...
	},
	{
		...
		Type        : 'Compressor',
		Use         : 'Mixing',
		Description : 'The Airwindows compressor, malleable into many forms if you know how',
		Comments    : ''
	},
	{
		Name        : 'PurestAir',
	...
	},
	{
		...
		Type        : 'EQ',
		Use         : 'Mixing',
		Description : 'Limit or wipe out the highest frEQuencies, near the Nyquist frEQuency',
		Comments    : ''
	},
	{
	...
	},
	{
		...
		Comments    : 'hyper-real, high-definition sound of extreme clarity and accuracy'
	},
	{
		Name        : 'Spiral',
		Type        : 'Saturation',
	...
	},
	{
		...
		Type        : 'Dither',
		Use         : 'Mastering',
		Description : 'StudioTan is all the ‘non-dither’ dithers, up to date and convenient.',
		Comments    : ''
	},
	{
		Name        : 'Surge',
	...
	},
	{
		...
		Type        : 'Gate',
		Use         : 'Mixing',
		Description : 'Swell is about stomping out attack transients until they’re all gone.',
		Comments    : 'Swell reacts to EVERY attack that comes along, provided the threshold’s set right.'
	},
	{
		Name        : 'Tape',
		Type        : 'Saturation',
	...
	},
	{
		...
		Type        : 'Compressor',
		Use         : 'Mixing',
		Description : 'With this buss compressor, sub-lows get bigger the harder you drive it.',
		Comments    : ''
	},
	{
		Name        : 'ToMono',
		Type        : 'Utility',
		Use         : 'Mixing',
		Description : 'ToMono (LeftoMono and RightoMono) copy one channel to both, losslessly.',
		Comments    : ''
	},
	{
		Name        : 'ToneSlant',
	...
	},
	{
		...
		Comments    : 'You can cut side-channel bass and tighten and control the extreme lows in the middle.'
	},
	{
		Name        : 'TPDF Dither',
		Type        : 'Dither',
	...
	},
	{
		...
		Comments    : 'This isn’t a plugin for making things soft and sweet, it’s for rocking out.'
	},
	{
		Name        : 'Tremolo',
		Type        : 'Modulation',
	...
	},
	{
		...
		Comments    : 'It acts like there’s a vintage tube rectifier, imparting an obvious rectifier sag.'
	},
	{
		Name        : 'uLaw',
		Type        : 'Mix Buss Replacement',
		Use         : 'Mixing',
		Description : 'uLaw is a Console-like encode/decode pair, but much more extreme.',
		Comments    : ''
	},
	{
		Name        : 'UnBox',
	...
	},
	{
		...
		Type        : 'Modulation',
		Use         : 'Mixing',
		Description : 'Vibrato lets you vibrato, chorus, flange, and make odd FM noises.',
		Comments    : ''
	},
	{
		Name        : 'VinylDither',
	...
	},
	{
		...
		Comments    : 'It lets you go from regular noise to deep dark noise to purely subsonic rumble. '
	},
	{
		Name        : 'VoiceTrick',
		Type        : 'Special',
		Use         : 'Recording',
		Description : 'VoiceTrick lets you record vocals while monitoring over speakers.',
		Comments    : ''
	},
	{
		Name        : 'Wider',
	...
	},
	{
		...
		Type        : 'Dither',
		Use         : 'Mastering',
		Description : 'Dark is a wordlength reducer that gives your music a blacker backdrop.',
		Comments    : ''
	},
	{
		Name        : 'Chrome Oxide',
	...
	},
	{
		...
		Type        : 'Utility',
		Use         : 'Mixing',
		Description : 'PurestFade is just like PurestGain, but with a MUCH smoother fade control',
		Comments    : ''
	},
	{
		Name        : 'Tape (Redux)',
